 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Admin\PastorController::descargarCedula
 * @see app/Http/Controllers/Admin/PastorController.php:482
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
export const descargarCedula = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: descargarCedula.url(args, options),
    method: 'get',
})

descargarCedula.definition = {
    methods: ["get","head"],
 ...
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
descargarCedula.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return descargarCedula.definition.url
 ...
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
descargarCedula.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: descargarCedula.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
descargarCedula.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: descargarCedula.url(args, options),
    method: 'head',
})
 ...
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
    const descargarCedulaForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: descargarCedula.url(args, options),
        method: 'get',
    })
 ...
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
        descargarCedulaForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: descargarCedula.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/pastores/{id}/cedula-descargar'
 */
        descargarCedulaForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: descargarCedula.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    descargarCedula.form = descargarCedulaForm
/**
...
const PastorController = { index, create, store, edit, descargarCedula, update, toggleStatus, bulkDestroy }
