        ...
        <tr>
            <td align="center">
                ...
                <div style="display: none; font-size: 1px; color: #f1ede5; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
                    Credenciales de acceso institucional como Presbítero del Movimiento Misionero Mundial Venezuela.
                </div>
                        ...
                        <td class="container-padding" style="padding: 30px 36px 20px 36px;">
                            ...
                            <div style="margin-bottom: 22px;">
                                <div style="font-size: 12px; font-weight: 900; color: #1a3786; text-transform: uppercase; letter-spacing: 0.8px; margin-bottom: 8px; border-bottom: 1px solid #e2e8f0; padding-bottom: 4px;">
                                    📍 Datos de Jurisdicción Asignada
                                </div>
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; font-size: 13px; line-height: 1.6;">
                                    <tr style="background-color: #f8fafc;">
                                        <td style="padding: 9px 14px; border: 1px solid #e2e8f0; font-weight: 700; color: #475569; width: 35%;">Zona(s):</td>
                                        <td style="padding: 9px 14px; border: 1px solid #e2e8f0; font-weight: 800; color: #1a3786;">{{ $zonas ?: 'Sin asignar' }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 9px 14px; border: 1px solid #e2e8f0; font-weight: 700; color: #475569;">Distrito(s):</td>
                                        <td style="padding: 9px 14px; border: 1px solid #e2e8f0; font-weight: 800; color: #1a3786;">{{ $distritos ?: 'Sin asignar' }}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="margin-bottom: 22px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; font-size: 13px; line-height: 1.65; color: #475569;">
                                    <li style="margin-bottom: 4px;">Dar seguimiento a las <strong>fichas ministeriales</strong> de los pastores a su cargo.</li>
                                    <li style="margin-bottom: 4px;">Consultar las <strong>iglesias y extensiones</strong> bajo su cobertura territorial.</li>
                                    <li style="margin-bottom: 4px;">Recibir <strong>balances y notificaciones automáticas</strong> ante nuevos registros.</li>
                                </ul>
                            </div>
